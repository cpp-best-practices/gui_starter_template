 ...
 * a basic CLI example
 * an example of using SDL
 * examples for fuzz, unit, and constexpr testing
 * github action testing matrix for all 3 platforms
...
If you want a simplified boilerplate, check out the [cpp_boilerplate_project](https://github.com/cpp-best-practices/cpp_boilerplate_project).
